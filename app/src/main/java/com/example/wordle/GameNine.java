...
public class GameNine extends Fragment implements View.OnClickListener{

    private View binding;
    private TextView[][] fields = new TextView[7][9];
